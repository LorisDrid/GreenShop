        ...
        {items.map((item: any, index: number) => (
          <article key={index}>
            <Skeleton className="border-r-4" loading={imageLoading}>
              <a href="" className="article-image-container">
                <img
              ...
              <button className="article-btn-favorite">
              ...
              <button className="article-btn-add">Quick Add</button>
            </Skeleton>
            <div className="article-content">
              ...
              <span className="flex justify-between">
                <a href="">
                  <Reviews
                    rating={item.rate}
                    numberOfReviews={item.rateCount}
                  />
                </a>
              ...
              <span className="flex justify-between">
                <div className="inline-flex items-center gap-2">
                  ...
                  <label
                    className="article-label-compare cursor-pointer"
                    htmlFor={"ripple-on-" + index}
                  >
                    Compare footprint
                  </label>
                      ...
                      <HoverCard.Root key={index}>
                        <HoverCard.Trigger>
                          <img
                            ...
                            alt={label.name}
                            className="article-label-image cursor-help"
                          />
                        </HoverCard.Trigger>
                  ...
                  <HoverCard.Root key={index}>
                    ...
                    <HoverCard.Content maxWidth="300px">
                      <Flex gap="1" direction="column">
                        ...
                        <Text as="div" size="2">
                          Measures the environmental impact of the product on a
                          scale of A to E. It is calculated based on the
                          product's carbon footprint, water usage, and waste
                          production.
                        </Text>
                      </Flex>
                    </HoverCard.Content>
